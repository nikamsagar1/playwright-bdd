...
from step_definitions.add_user_steps import *  # noqa: F401, F403
from step_definitions.assign_leave_steps import *  # noqa: F401, F403
...
scenarios("../features/assign_leave.feature")
